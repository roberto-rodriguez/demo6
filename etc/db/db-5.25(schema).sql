...
-- Started on 2015-05-25 18:42:05
...
ALTER SEQUENCE comment_id_seq1 OWNED BY comment.id;
...
ALTER TABLE ONLY comment ALTER COLUMN id SET DEFAULT nextval('comment_id_seq1'::regclass);
...
-- Completed on 2015-05-25 18:42:07
